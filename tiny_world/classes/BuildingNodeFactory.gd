...
var buildingPropertyDict = {
	TYPE.HOUSING: {
		...
		HOUSING.METROPOLIS: BuildingProperty.new(200, 0, 0, 15, 600, "res://instances/game/houses/Metropolis.tscn"),
	},
	TYPE.PRODUCTION: {
		...
		PRODUCTION.PRODUCTIONPLANT: BuildingProperty.new(-60, 100, 0, 50, 1000, "res://instances/game/production/ProductionPlant.tscn"),
	},
	TYPE.RESEARCH: {
		...
		RESEARCH.UNIVERSITY: BuildingProperty.new(-100, 0, 100, 0, 1000, "res://instances/game/research/University.tscn"),
	},
	TYPE.PASTURE: {
